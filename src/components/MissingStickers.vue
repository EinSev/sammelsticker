...
const missingNumbers = [
  3, 6, 7, 10, 12, 14, 16, 20, 21, 23, 24, 25, 30, 32, 39, 51, 52, 56, 57, 58, 63, 64, 74, 83, 94, 103, 104, 106, 114, 116, 120, 133, 134, 136, 137, 141, 142, 144, 145, 148, 151, 156, 157, 158, 159, 170, 176, 180,
];
...
<template>
  <div class="flex flex-col justify-center items-center mt-36">
    ...
    <div id="do-we-have-it" class="flex flex-col justify-center items-center">
      ...
      <div>
        ...
        <p v-if="error" class="accent-red-600 font-bold">Nicht zwischen 0 und 180</p>
      </div>

      <div v-if="((result !== null) || (inputNumber !== null)) && error === false" class="mt-4 text-center">
        <p class="text-lg font-semibold">Ergebnis:</p>
        <p v-if="!result" class="text-red-600">Die Nummer <strong>{{ inputNumber }}</strong> ist bereits in unserer
          Sammlung</p>
        <p v-if="duplicate">Wir haben diesen Sticker sogar <strong>{{ duplicate }}x</strong> doppelt</p>
